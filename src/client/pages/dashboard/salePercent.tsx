...
const SalePercent: FC<{ loading: boolean }> = ({ loading }) => {
    ...
    return (
        <Card
            style={{ marginTop: 12 }}
            title={'app.dashboard.salePercent.proportionOfSales'}
            loading={loading}
            extra={
                <Radio.Group value={dataType} onChange={(e) => setDataType(e.target.value)} buttonStyle="solid">
                    <Radio.Button value="all">{'app.dashboard.salePercent.all'}</Radio.Button>
                    <Radio.Button value="online">{'app.dashboard.salePercent.online'}</Radio.Button>
                    <Radio.Button value="offline">{'app.dashboard.salePercent.offline'}</Radio.Button>
                </Radio.Group>
            }
        >
            <Row gutter={20}>
