    ...
    return (
        <div className="trend" style={style}>
            <div className="trend-item">
                <span className="trend-item-label">app.dashboard.overview.wowChange</span>
                <span className="trend-item-text">{wow}</span>
                <CaretUpIcon />
            </div>
            <div className="trend-item">
                <span className="trend-item-label">app.dashboard.overview.dodChange</span>
...
const Overview: FC<{ loading: boolean }> = ({ loading }) => {
    ...
    return (
        <Row gutter={[12, 12]}>
            <ColCard
                loading={loading}
                metaName={'app.dashboard.overview.totalSales'}
                metaCount="¥ 126,560"
            ...
            <ColCard
                loading={loading}
                metaName={'app.dashboard.overview.visits'}
                metaCount="8846"
                body={<Line {...config} />}
                footer={<Field name={'app.dashboard.overview.dailySales'} number="1234" />}
            />
            {/* <ColCard
        loading={loading}
