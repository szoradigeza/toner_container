    ...
    <div className="trend" style={style}>
      <div className="trend-item">
        <span className="trend-item-label">
          app.dashboard.overview.wowChange
        </span>
      ...
      <div className="trend-item">
        <span className="trend-item-label">
          app.dashboard.overview.dodChange
        </span>
  ...
  return (
    <Row gutter={[12, 12]}>
      <ColCard
        ...
        footer={
          <Field name={"app.dashboard.overview.dailySales"} number="￥12,423" />
        }
      />
      <ColCard
        loading={loading}
        ...
        body={<Line {...config} />}
        footer={
          <Field name={"app.dashboard.overview.dailySales"} number="1234" />
        }
      />
      {/* <ColCard
        loading={loading}
